      ...
      <div className="relative h-48 overflow-hidden rounded-lg bg-gray-100">
        {isCurrentVideo ? (
          <div className="relative w-full h-full">
            ...
            <div className="video-fallback absolute inset-0 flex items-center justify-center bg-gray-200">
              <div className="text-center text-gray-500">
        ...
        <div className=" media-placeholder absolute inset-0 flex items-center justify-center bg-gray-200 rounded-lg">
          <div className="text-center text-gray-500">
            <Image className="h-12 w-12 mx-auto mb-2" />
            <span className="text-sm">No media available</span>
          </div>
